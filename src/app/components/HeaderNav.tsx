...
const HeaderNav = () => {
  ...
  return (
    <header
      className={`h-[200px] relative w-full px-6 bg-cover bg-center bg-no-repeat grid grid-rows-2 gap-[40px] justify-center items-center xl:h-[300px] bg-mobile-${themeClass} xl:bg-desktop-${themeClass}`}
    >
