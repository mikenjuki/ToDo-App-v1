...
const Profile = () => {
  ...
  return (
    <>
      ...
      <section className="grid grid-rows-2 items-center mx-auto relative top-[-1rem] xl:top-[-3rem] w-[327px] xl:w-[540px]">
        ...
        <div className="profile-details flex flex-col relative xl:top-[-4rem]">
          <button
